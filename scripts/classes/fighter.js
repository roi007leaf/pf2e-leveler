export const FIGHTER = {
  ...
  classFeatures: [
    ...
    { level: 7, name: 'Battlefield Surveyor', key: 'battlefield-surveyor', proficiencies: { perception: 3 } },
    ...
    { level: 11, name: 'Fighter Expertise', key: 'fighter-expertise', proficiencies: { classdc: 2 } },
    ...
    { level: 19, name: 'Versatile Legend', key: 'versatile-legend', proficiencies: { classdc: 4 } },
  ],
