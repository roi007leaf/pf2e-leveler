export const GUNSLINGER = {
  ...
  classFeatures: [
    ...
    { level: 9, name: 'Gunslinger Expertise', key: 'gunslinger-expertise', proficiencies: { classdc: 2 } },
    { level: 11, name: 'Blast Dodger', key: 'blast-dodger' },
    { level: 13, name: 'Gunslinging Legend', key: 'gunslinging-legend', proficiencies: { classdc: 4 } },
